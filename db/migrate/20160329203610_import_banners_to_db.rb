class ImportBannersToDb < ActiveRecord::Migration
  def up
    execute(<<-SQL)
      ...
      INSERT INTO banners (id, page_id, title, description, background_image_file_name, background_image_content_type, background_image_file_size, background_image_updated_at, button_label, button_url, created_at, updated_at, title_html_tag) VALUES(3,4,'Contact us','','radok-web-banner-contacts.png','image/jpeg',91847,'2015-10-06 10:39:39.462184','','','2015-10-06 10:39:39.498825','2015-10-14 17:08:02.319851','div');
      INSERT INTO banners (id, page_id, title, description, background_image_file_name, background_image_content_type, background_image_file_size, background_image_updated_at, button_label, button_url, created_at, updated_at, title_html_tag) VALUES(4,9,'Device Lab','Test devices','radok-web-banner-device-lab.png','image/png',166077,'2015-10-06 10:40:51.060108','','','2015-10-06 10:40:51.092248','2015-10-14 17:08:02.437748','div');
      ...
      INSERT INTO banners (id, page_id, title, description, background_image_file_name, background_image_content_type, background_image_file_size, background_image_updated_at, button_label, button_url, created_at, updated_at, title_html_tag) VALUES(8,10,'','- Only 4 easy steps to make Your web app/web work bugless!','radok-web-banner-wizard.png','image/png',52378,'2015-10-06 10:42:44.090407','','','2015-10-06 10:42:44.133588','2015-10-14 17:08:02.934476','div');
      INSERT INTO banners (id, page_id, title, description, background_image_file_name, background_image_content_type, background_image_file_size, background_image_updated_at, button_label, button_url, created_at, updated_at, title_html_tag) VALUES(9,11,'FAQ','Get an answer to what You may not know.','radok-web-banner-FAQ.png','image/png',67093,'2015-10-06 10:58:53.681720','','','2015-10-06 10:58:53.722225','2015-10-14 17:08:03.068149','div');
    SQL

    {
      '1' => 'radok-web-banner-about-us.png',
      '2' => 'radok-web-banner-dashboard.png',
      '3' => 'radok-web-banner-contacts.png',
      '4' => 'radok-web-banner-device-lab.png',

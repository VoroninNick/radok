class ImportWizardProductTypesToDb < ActiveRecord::Migration
  def up
    execute(<<-SQL)
      ...
      INSERT INTO wizard_product_types (id, name, image_file_name, image_content_type, image_file_size, image_updated_at, created_at, updated_at) VALUES(2,'Responsive website','rf-responsive.svg','image/svg+xml',7631,'2015-09-23 10:39:00.490595','2015-09-23 10:39:00.506045','2015-09-23 10:39:00.506045');

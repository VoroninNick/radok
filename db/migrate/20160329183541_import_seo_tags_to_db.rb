class ImportSeoTagsToDb < ActiveRecord::Migration
  def up
    execute(<<-SQL)
      ...
      INSERT INTO seo_tags (id, page_type, page_id, title, keywords, description, created_at, updated_at) VALUES(9,'Page',6,'Crowdsourced Testing Services | 10G Force','','Deadline is close? Do you need functional, localization or usability testing? We crowd test every platform with a force of 10G.  ','2015-10-14 16:13:52.318311','2015-10-14 16:13:52.318311');
      INSERT INTO seo_tags (id, page_type, page_id, title, keywords, description, created_at, updated_at) VALUES(10,'Page',5,'Crowdsourced testing cost | Pricing plan by 10G Force ','','Our simple self-driving plan costs $29 per hour/platform or define your expectations for a special software product with our devoted project manager.  ','2015-10-14 16:14:27.806785','2015-10-14 16:15:08.536073');

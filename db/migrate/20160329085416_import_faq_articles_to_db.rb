class ImportFaqArticlesToDb < ActiveRecord::Migration
  def up
    execute(<<-SQL)
      ...
      ','2015-06-04 11:04:42.945149','2015-10-16 08:13:08.653782','what-is-radok-force');
      INSERT INTO faq_articles (id, published, name, content, created_at, updated_at, url_fragment) VALUES(2,'t','Who are 10G-Force testers?','<p>Our testers are a team of 1500+ professional, experienced and certified Quality Assurance engineers with hands-on testing experience. We don&rsquo;t employ freelancers or juniors. All of our employees have proven their qualifications and have 3+ years of working experience. Our teams guarantee an accurate, fast and cost-effective testing that ensures flawless products.</p>
      ','2015-06-04 11:05:28.759587','2015-10-16 08:14:32.419095','who-are-radok-force-testers');
      ...
      INSERT INTO faq_articles (id, published, name, content, created_at, updated_at, url_fragment) VALUES(6,'t','How much does it cost?','<p>We offer a standart pricing package, which includes the most common testing deviсes and environments. No hidden payments - you can see the total cost to you before you even sign up. Also, you can customize your package and fit it for your needs. If you have any custom preferences, please contact us and we will work with you to meet your needs.</p>
      ','2015-06-04 11:27:10.042048','2015-10-16 08:41:12.012816','how-much-does-it-cost');
      INSERT INTO faq_articles (id, published, name, content, created_at, updated_at, url_fragment) VALUES(7,'t','Can I get test reports sent directly to my bug-tracking system?','<p>Yes! You and your developers won&rsquo;t even feel the difference. Our testing team will work with your bug-tracking system and provide all bug reports and test results in a manner that is easy and convenient convenient for you.</p>
      ','2015-06-04 11:27:35.016385','2015-10-16 08:40:57.636147','can-i-get-test-reports-directly-in-my-bug-tracking-system');
      INSERT INTO faq_articles (id, published, name, content, created_at, updated_at, url_fragment) VALUES(8,'t','What kind of testing does 10G-Force perform?','<p>Radok mainly focuses on functional testing, localization testing, and UI/UX testing. You can choose the type of testing you would like to perform when filling out the request form.</p>
      ','2015-06-04 11:27:53.516286','2015-10-16 08:33:28.335616','what-kind-of-testing-does-radok-perform');
      INSERT INTO faq_articles (id, published, name, content, created_at, updated_at, url_fragment) VALUES(9,'t','What results do I get?','<p>After thorough testing, you will receive comprehensive test report and defect list from our team. Each defect has standard attributes and you will be able to filter and sort all the bugs by type, severity, priority or app modules. Standard bug reports including comprehensive descriptions of the issue (with screenshots) will be presented to you and your developers. At the end of the testing process, you will also receive reliable statistics, according to the whole testing phase.</p>
      ','2015-06-04 11:28:13.837786','2015-10-16 08:40:25.745226','what-results-do-i-get');
      INSERT INTO faq_articles (id, published, name, content, created_at, updated_at, url_fragment) VALUES(10,'t','Can I contact my 10G-Force tester team?','<p>Of course! We believe that communication is the key to successful solutions. Once your project is assigned to the team, the team lead will contact you to clarify if you have any questions or specific requirements. During the entire testing period, you will be able to communicate with your team whenever you want in a way that is convenient to you.</p>
      ','2015-06-04 11:28:34.276626','2015-10-16 08:40:12.720996','can-i-contact-with-my-radok-testers-team');
    SQL
  end
